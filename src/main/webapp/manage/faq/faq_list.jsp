		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div
					...
					<h1 class="h2"><!-- 선택한 사이드바 이름 -->자주 묻는 질문 관리</h1>
				</div>
				<div>
					...
					<!-- service에서 가져온 자주 묻는 질문 뿌려주기 -->
<!--  				<thead>
					<tr>
						<td>자주 묻는 질문이 없습니다.</td>
					</tr>
					</thead> -->
					<%
					for(int i = 0; i<16;i++){
					%>
 					<tr>
						<td class="list_title"><a class="nav-link text-black" href="faq_modify.jsp"><span>자주 묻는 질문 제목</span></a></td>

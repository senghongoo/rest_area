				...
				<div>
					...
					<div id="middle">
						...
						<div style="margin: 11px;">
							...
							<label class="col-sm-2 col-form-label">작성일 : <span>yyyy-MM-dd
									HH:mm</span></label>
						</div>
						<div>
					...
					<div id="bottom" class="d-flex justify-content-between">
						<div class="input-group">
							<input type="file" class="form-control" /> <input type="button" class="btn btn-outline-secondary" value="파일첨부" />
						</div>
						<div>

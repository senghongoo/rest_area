					...
					<form method="POST" action="" id="frm">
						...
						<div id="bottom" class="d-flex justify-content-between">
							<div class="input-group">
								<input type="file" class="form-control" /> <input type="button"
									class="btn btn-outline-secondary" value="파일첨부" />
							</div>
							<div>
								<input type="button" value="취소"
									class="btn btn-outline-secondary" /> <input type="button"
									value="저장" class="btn btn-outline-secondary" />
							</div>
						</div>
						<!-- bottom -->
					</form>
